...
struct TagDetection {
  ...
  */
  ...
  cv::Matx44d getRelativeTransformCv(double tag_size, double fx, double fy,
                                     double px, double py) const;
  ...
  void getRelativeTranslationRotationCv(double tag_size, double fx, double fy, double px, double py,
